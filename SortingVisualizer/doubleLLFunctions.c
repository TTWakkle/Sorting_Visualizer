...
//Inserts an item into the end of the DLL
    int insert(DOUBLY_LIST* dLL, void* itmPtr){
        ...
        //Increasing the number of items stored in the DLL, Dictating where the new rear of the queue is, providing the new node an index, and returning 1 for a successful run
...
//Returns a memory address that points to (value) at the BACK of the DLL structure


//Prints out the tiems stored in the DLL, starting from the front
